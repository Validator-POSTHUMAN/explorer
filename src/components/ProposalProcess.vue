...
<template>
  <div class="progress rounded-full h-6 text-xs flex items-center">
    <div
      class="h-6 bg-[#0D4410] flex items-center pl-2 text-white overflow-hidden"
      :style="`width: ${yes}`"
      :title="yes"
    >
      {{ yes }}
    ...
    <div
      class="h-6 bg-[#621616] flex items-center text-white overflow-hidden"
      :style="`width: ${no}`"
      :title="no"
    >
      {{ no }}
    ...
    <div
      class="h-6 bg-[#562E99] flex items-center text-white overflow-hidden"
      :style="`width: ${abstain}`"
      :title="abstain"
    >
      {{ abstain }}
